...
import com.example.negociomx_hyundai.databinding.ActivityMainBinding
import com.example.negociomx_hyundai.room.BLL.BLLUtil
import com.example.negociomx_hyundai.room.BLL.appSettingOpen
import com.example.negociomx_hyundai.room.BLL.gone
import com.example.negociomx_hyundai.room.BLL.warningPermissionDialog
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    private fun bindCameraUserCases() {
        ...
        preview.setSurfaceProvider(mainBinding.previewView.surfaceProvider)
    ...
    private fun takePhoto() {
        val imageFolder = File(
            Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOCUMENTS), "imgNegMX"
        )
        ...
        imageCapture.takePicture(
            ...
            object : ImageCapture.OnImageSavedCallback {
                override fun onImageSaved(outputFileResults: ImageCapture.OutputFileResults) {
                    ...
                    var nombreCad = outputFileResults.savedUri?.let {
                        bllUtil.getUriRealPath(
                            applicationContext,
                            it
                        ).toString()
                    }

                    val nombreArchivoGuardado = outputFileResults.savedUri.toString()
                    intent.putExtra("nombreFotoArchivo", nombreCad)
